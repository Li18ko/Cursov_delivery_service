...
public class DatabaseConnection{
    ...
    public int makeOrder(Parcle parcle) throws SQLException {
        ...
        String query3 = "INSERT INTO parcels(couriers_id, typeDelivery, weight, data) VALUES (?, ?, ?, ?)";
        PreparedStatement statement3 = connection.prepareStatement(query3);
        ...
        String query5 = "SELECT id FROM parcels WHERE couriers_id = ? and typeDelivery = ? and weight = ? and data = ?";
